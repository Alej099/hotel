        ...
        <div class="container">
            <div class="header-bottom-row">
                ...
                <nav class="header-nav">
                    <ul>
                        <li><a href="index.php#s-about">Acerca de nosotros</a></li>
                        <li><a href="index.php#s-services">Nuestros servicios</a></li>
                        <li><a href="index.php#s-gallery">Galería</a></li>
                        <li><a href="index.php#s-testimonials">Nuestros hoteles</a></li>
                        <li><a href="index.php" class="active">Salir</a></li>
                    </ul>
                </nav>
            </div>
        </div>
      ...
      <?php foreach ($habitaciones as $hab): ?>
        <div class="services-item wow fadeIn" data-wow-delay="0.3s">
          <div class="services-thumb">
            <img src="<?= htmlspecialchars($hab['disponibilidad'] ? $hab['imagen'] : 'images/no.jpg') ?>" 
          ...
          <div class="services-body">
            ...
            <?php if ($hab['disponibilidad']): ?>
              <!-- Botón azul "Reservar" -->
              <a href="reserva.php?id=<?= $hab['id'] ?>" 
                style="display:inline-block;padding:10px 20px;background-color:#007bff;color:white;text-decoration:none;border-radius:5px;">
                Reservar
              </a>
            <?php else: ?>
              <!-- Botón rojo "Cancelar" -->
              <a href="cancelar.php?id=<?= $hab['id'] ?>" 
